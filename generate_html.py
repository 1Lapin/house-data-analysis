...
<head>
    ...
    <style>
        * {
        ...
        .kpi-icon.purple { background: rgba(123,44,191,0.2); }
        .kpi-icon.green { background: rgba(0,255,136,0.2); }
        .kpi-icon.orange { background: rgba(255,170,0,0.2); }
        .kpi-value {
            font-size: 32px;
            font-weight: 700;
            margin-bottom: 5px;
...
<body>
        ...
        <div class="chart-container">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">单位: 元/平方米</div>
                </div>
            </div>
        ...
        <div class="chart-container">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">统计区间</div>
                </div>
            </div>
        ...
        <div class="chart-container">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">按建筑面积分类</div>
                </div>
            </div>
        ...
        <div class="chart-container">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">按建造年份分类</div>
                </div>
            </div>
        ...
        <div class="chart-container">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">房源装修状态统计</div>
                </div>
            </div>
        ...
        <div class="chart-container">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">低/中/高楼层占比</div>
                </div>
            </div>
        ...
        <div class="chart-container full-width">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">气泡大小代表总价 | 颜色深浅代表房龄</div>
                </div>
            </div>
        ...
        <div class="chart-container">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">供应热度分析</div>
                </div>
            </div>
    ...
    <footer class="footer">
        <p>📊 长沙二手房数据可视化仪表盘 | 基于 Python + ECharts 构建</p>
    </footer>
    ...
    <script>
        ...
        function updateCharts() {
            ...
            charts.chart6.setOption({
                ...
                xAxis: { type: 'value', name: '面积 (㎡)', nameTextStyle: { color: '#8892b0' }, axisLine: { lineStyle: { color: '#8892b0' } }, axisLabel: { color: '#8892b0' }, splitLine: { lineStyle: { color: 'rgba(255,255,255,0.05)' } } },
                yAxis: { type: 'value', name: '单价 (元/㎡)', nameTextStyle: { color: '#8892b0' }, axisLine: { lineStyle: { color: '#8892b0' } }, axisLabel: { color: '#8892b0' }, splitLine: { lineStyle: { color: 'rgba(255,255,255,0.05)' } } },
            ...
            districtNames.forEach(name => {
                ...
                const medianPrice = d.prices.sort((a, b) => a - b)[Math.floor(d.prices.length / 2)];
                row.innerHTML = `
